...
// ../../node_modules/.pnpm/@codemirror+text@0.18.0/node_modules/@codemirror/text/dist/index.js
...
function countColumn(string2, n, tabSize2) {
...
function findColumn(string2, n, col, tabSize2) {
  for (let i = 0; i < string2.length; ) {
    if (n >= col)
...
// ../../node_modules/.pnpm/@codemirror+state@0.18.7/node_modules/@codemirror/state/dist/index.js
var DefaultSplit = /\r\n?|\n/;
...
// ../../node_modules/.pnpm/@codemirror+rangeset@0.18.1/node_modules/@codemirror/rangeset/dist/index.js
...
// ../../node_modules/.pnpm/@codemirror+view@0.18.13/node_modules/@codemirror/view/dist/index.js
...
function moveVertically(view, start, forward, distance) {
  ...
  let {doc: doc2} = view.state, line = doc2.lineAt(startPos), tabSize2 = view.state.tabSize;
  let goal = start.goalColumn, goalCol = 0;
  if (goal == null) {
    for (const iter = doc2.iterRange(line.from, startPos); !iter.next().done; )
      goalCol = countColumn(iter.value, goalCol, tabSize2);
  ...
  for (const iter = doc2.iterRange(otherLine.from, otherLine.to); seen >= goalCol && !iter.next().done; ) {
    const {offset, leftOver} = findColumn(iter.value, seen, goalCol, tabSize2);
...
function applyDOMChange(view, start, end, typeOver) {
  ...
  if (change) {
    ...
    if (view.state.facet(inputHandler).some((h3) => h3(view, change.from, change.to, text)))
      return;
    if (view.inputState.composing >= 0)
...
// ../../node_modules/.pnpm/lezer-tree@0.13.2/node_modules/lezer-tree/dist/tree.es.js
...
// ../../node_modules/.pnpm/@codemirror+language@0.18.1/node_modules/@codemirror/language/dist/index.js
...
// ../../node_modules/.pnpm/@codemirror+highlight@0.18.4/node_modules/@codemirror/highlight/dist/index.js
var nextTagID = 0;
var Tag = class {
...
// ../../node_modules/.pnpm/@codemirror+stream-parser@0.18.2/node_modules/@codemirror/stream-parser/dist/index.js
function countCol(string2, end, tabSize2, startIndex = 0, startValue = 0) {
  if (end == null) {
    end = string2.search(/[^\s\u00a0]/);
    if (end == -1)
      end = string2.length;
  }
  return countColumn(string2.slice(startIndex, end), startValue, tabSize2);
}
var StringStream = class {
  constructor(string2, tabSize2, indentUnit2) {
    this.string = string2;
...
var StreamLanguage = class extends Language {
  constructor(parser4) {
    let data = defineLanguageFacet(parser4.languageData);
    let p = fullParser(parser4);
...
// ../../node_modules/.pnpm/lezer@0.13.5/node_modules/lezer/dist/index.es.js
var Stack = class {
...
// ../../node_modules/.pnpm/lezer-javascript@0.13.4/node_modules/lezer-javascript/dist/index.es.js
var noSemi = 269;
var incdec = 1;
var incdecPrefix = 2;
...
// ../../node_modules/.pnpm/@codemirror+tooltip@0.18.4/node_modules/@codemirror/tooltip/dist/index.js
...
// ../../node_modules/.pnpm/@codemirror+autocomplete@0.18.5/node_modules/@codemirror/autocomplete/dist/index.js
...
// ../../node_modules/.pnpm/@codemirror+lang-javascript@0.18.0/node_modules/@codemirror/lang-javascript/dist/index.js
var snippets = [
...
// ../../node_modules/.pnpm/lezer-html@0.13.5/node_modules/lezer-html/dist/index.es.js
var StartTag = 1;
var StartCloseTag = 2;
var MismatchedStartCloseTag = 3;
var missingCloseTag = 33;
var IncompleteCloseTag = 4;
var SelfCloseEndTag = 5;
var commentContent = 34;
var Element = 10;
var OpenTag = 11;
var RawText = 25;
...
// ../../node_modules/.pnpm/lezer-css@0.13.1/node_modules/lezer-css/dist/index.es.js
var descendantOp = 92;
var Unit = 1;
var callee = 93;
var identifier = 94;
...
var descendant = new ExternalTokenizer((input, token) => {
  if (space2.includes(input.get(token.start - 1))) {
...
var unitToken = new ExternalTokenizer((input, token) => {
  let {start} = token;
  if (!space2.includes(input.get(start - 1))) {
...
// ../../node_modules/.pnpm/@codemirror+lang-css@0.18.0/node_modules/@codemirror/lang-css/dist/index.js
...
// ../../node_modules/.pnpm/@codemirror+lang-html@0.18.1/node_modules/@codemirror/lang-html/dist/index.js
...
var htmlLanguage = /* @__PURE__ */ LezerLanguage.define({
...
var htmlCompletion = /* @__PURE__ */ htmlLanguage.data.of({autocomplete: completeHTML});
function html() {
  return new LanguageSupport(htmlLanguage, [htmlCompletion, javascript().support, css().support]);
}

// ../../node_modules/.pnpm/@codemirror+legacy-modes@0.18.0/node_modules/@codemirror/legacy-modes/mode/css.js
...
// ../../node_modules/.pnpm/@codemirror+history@0.18.1/node_modules/@codemirror/history/dist/index.js
...
// ../../node_modules/.pnpm/@codemirror+gutter@0.18.3/node_modules/@codemirror/gutter/dist/index.js
...
// ../../node_modules/.pnpm/@codemirror+fold@0.18.1/node_modules/@codemirror/fold/dist/index.js
...
// ../../node_modules/.pnpm/@codemirror+matchbrackets@0.18.0/node_modules/@codemirror/matchbrackets/dist/index.js
...
// ../../node_modules/.pnpm/@codemirror+commands@0.18.2/node_modules/@codemirror/commands/dist/index.js
...
// ../../node_modules/.pnpm/@codemirror+closebrackets@0.18.0/node_modules/@codemirror/closebrackets/dist/index.js
var defaults3 = {
  brackets: ["(", "[", "{", "'", '"'],
  before: `)]}'":;>`
};
...
function insertBracket(state, bracket2) {
  ...
  for (let tok of tokens) {
    ...
    if (bracket2 == tok)
      return closed == tok ? handleSame(state, tok, tokens.indexOf(tok + tok + tok) > -1) : handleOpen(state, tok, closed, conf.before || defaults3.before);
...
// ../../node_modules/.pnpm/@codemirror+panel@0.18.2/node_modules/@codemirror/panel/dist/index.js
...
// ../../node_modules/.pnpm/@codemirror+search@0.18.3/node_modules/@codemirror/search/dist/index.js
...
// ../../node_modules/.pnpm/@codemirror+comment@0.18.1/node_modules/@codemirror/comment/dist/index.js
...
// ../../node_modules/.pnpm/@codemirror+rectangular-selection@0.18.0/node_modules/@codemirror/rectangular-selection/dist/index.js
var MaxOff = 2e3;
...
function absoluteColumn(view, x) {
  let ref4 = view.coordsAtPos(view.viewport.from);
  return ref4 ? Math.round(Math.abs((ref4.left - x) / view.defaultCharacterWidth)) : -1;
}
...
// ../../node_modules/.pnpm/@codemirror+lint@0.18.3/node_modules/@codemirror/lint/dist/index.js
...
function usePrismCSS(getStyle) {
  const plainCSS = _vue.ref.call(void 0, "");
  const highlightedCSS = _vue.ref.call(void 0, "");
  _vue.watchEffect.call(void 0, () => {
    const style = getStyle();
    plainCSS.value = style;
    highlightedCSS.value = _prismjs2.default.highlight(style, _prismjs2.default.languages.css, "css").trim();
  });
  return {
    plainCSS,
    highlightedCSS
...
// src/components/Editor.ts
var Editor_default = _vue.defineComponent.call(void 0, {
  name: "Editor",
  props: {
    modelValue: {
      type: String,
  ...
  setup(props, {emit}) {
    ...
    async function initEditor() {
      ...
      if (props.language === "css")
        extensions.push(StreamLanguage.define(css2));
    ...
    _vue.onMounted.call(void 0, async () => {
      await _vue.nextTick.call(void 0, async () => {
        await initEditor();
      });
    });
...
// src/components/IframePreview.ts


// raw-loader:/Users/hanlee/Project/windi/shared/packages/shared-components/src/srcdoc.html?raw
...
// src/components/IframePreview.ts
var IframePreview_default = _vue.defineComponent.call(void 0, {
  props: {
    dark: {
      type: Boolean,
      default: false
  ...
  setup(props) {
    _vue.onMounted.call(void 0, createSandBox);
    const container = _vue.ref.call(void 0, null);
    let sandbox;
    function createSandBox() {
      var _a, _b;
      if (sandbox)
        (_a = container.value) == null ? void 0 : _a.removeChild(sandbox);
      ...
      (_b = container.value) == null ? void 0 : _b.appendChild(sandbox);
      sandbox.addEventListener("load", () => {
        isReady.value = true;
      });
    }
    const isReady = _vue.ref.call(void 0, false);
    const propRefs = _vue.toRefs.call(void 0, props);
    for (const key of Object.keys(propRefs)) {
      _vue.watchEffect.call(void 0, () => {
        var _a;
        if (!isReady.value)
          return;
        (_a = sandbox == null ? void 0 : sandbox.contentWindow) == null ? void 0 : _a.postMessage(JSON.stringify({
    ...
    _vue.watchEffect.call(void 0, () => {
      ...
      if (!isReady.value)
        return;
      (_d = (_c = (_b = (_a = sandbox.contentWindow) == null ? void 0 : _a.document) == null ? void 0 : _b.querySelector("html")) == null ? void 0 : _c.classList) == null ? void 0 : _d.toggle("dark", props.dark);
    });
    return () => _vue.h.call(void 0, "div", {
      ref: container,
...
exports.Editor = Editor_default; exports.IframePreview = IframePreview_default; exports.basicSetup = basicSetup; exports.hoverPreview = hoverPreview;
