...
import {defineComponent, h, nextTick, onMounted, ref as ref2, onUnmounted} from "vue";
...
import {ref as ref3, toRefs, watchEffect as watchEffect2, onMounted as onMounted2, defineComponent as defineComponent2, h as h2} from "vue";
...
// src/components/IframePreview.ts
var IframePreview_default = defineComponent2({
  props: {
    dark: {
      type: Boolean,
      default: false
  ...
  setup(props) {
    onMounted2(createSandBox);
    const container = ref3(null);
    let sandbox;
...
export {
  ...
  IframePreview_default as IframePreview,
  basicSetup,
  hoverPreview
};
